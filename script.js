...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Feb 25, 2023 00:00:00").getTime(),
  x = setInterval(function () {
    ...
    if (distance < 0) {
      ...
      clearInterval(x);
      if (typeof _slideSatu === "function") _slideSatu();
    }
  }, second);
...
new TypeIt("#teks1", {
  strings: [
    "Hari ini, aku berikan semua doa terbaik aku untuk kamu.",
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "Selamat Ulang Tahun, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true,
}).go();
